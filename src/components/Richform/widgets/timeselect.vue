...
<template>
  <div class="time-select-widget" ref="timeSelect" :id="widgetId">
    <div class="time-input">
      ...
      <input class="input" v-model="value" type="text" autocomplete="off" name=""
        :readonly="field.valueFormat == 'timestamp'" placeholder="任意时间点" @focus="() => onFocus(value)">
    </div>
    <div class="time-select-panel" v-show="showTimeSelect">
      <div class="options">
    ...
    registerAddEventListener() {
      this.$nextTick(() => {
        window.addEventListener("click", (event) => {
          if (this.$refs.timeSelect && !this.$refs.timeSelect.contains(event.target)) {
